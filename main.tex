...
For $n$ Monte Carlo samples, the volume estimator $\hat{V}_{\mathrm{ice}}^{(n)}$ converges to the true expected volume in $\bigO{1/\sqrt{n}}$ in accordance with standard Monte Carlo integration. We enforce $n = 10\,000$ to ensure the standard error remains strictly bounded below 1\% of the sample standard deviation.
