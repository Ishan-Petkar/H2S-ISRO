...
\textit{Choice of $2\sigma$ untuned prior.}
...
Cost Map Weights & $\alpha,\beta,\gamma,\delta$ & $0.4, 0.3, 0.2, 0.1$ & Heuristic baseline favouring targets over hazards (Untuned Prior). \\
